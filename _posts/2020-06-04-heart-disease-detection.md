...
categories: journal
tags: [healthcare,data science,data analysis,machine learning]
image: heart.png
---
...
Code snippets will be provided for each section outlined in the [Project Overview](#project-overview) at the bottom of this page. The snippets will encompass the entire script, just broken into their related sections. If you would like to view the code script in its entirety, please visit this [link](https://github.com/dustinwicker/Heart-Disease-Detection/blob/master/heart_disease_code.py/){:target="_blank" rel="noopener"}.
